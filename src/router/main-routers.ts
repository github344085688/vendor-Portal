    ...
    children: [
      {
        title: "TMS",
        name: "TMS",
        icon: require("../assets/img/nav-icons/2.svg"),
        children: [
          {
            parentName: "TMS",
            path: "TMS/invoices",
      ...
      },
      {
        ...
        path: "service",
        component: Service,
        icon: require("../assets/img/nav-icons/3.svg"),
      },
    ],
  },
  {
    ...
    children: [
      {
        title: "Payments ",
        name: "Payments",
        icon: require("../assets/img/nav-icons/4.svg"),
        children: [
          {
            parentName: "Payments",
      ...
      },
      {
        title: "Business Info  ",
        name: "BusinessInfo",
        icon: require("../assets/img/nav-icons/5.svg"),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        name: "MessageCenter",
        icon: require("../assets/img/nav-icons/6.svg"),
      },
      {
        title: "Settings",
        name: "Settings",
        icon: require("../assets/img/nav-icons/7.svg"),
      },
    ],
  },
];

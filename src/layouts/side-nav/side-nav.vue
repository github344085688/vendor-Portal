        ...
        <div class="unis-navigation">
            <div class="aside-unfold" :class="{'aside-fold':isFold}">
                ...
                <div class="parent-level-big" :class="{'parent-level-small':isLevelSmall ||isFold}">
                    ...
                    <div class="nav-link-detales" :class="[isFold?'':'overflow-y']" style="height: calc(100% - 160px); ">
                        <div class="nav-link-groud" v-for="(child, navLinkindex) in navLink" :key="navLinkindex">
                            ...
                            <div v-for="(item, childsIndex) in child.children" :key="childsIndex"
                                ...
                                <div :class="[isFold?'hover-details':'childs-box',(navName != item.name && !isFold)?'show-childs':'']"  v-if="itemChildren.length>0"
                                     :style="{'height':(48* itemChildren.length)+'px'}">
                                    <div :class="[isFold?'hover-details-box':'' ]">
                                        <div class="pt-0 pb-0 pl-0" :class="[isFold?'hover-details-item':'child-item' ]"  v-for="nav in itemChildren">
                                            <div class="line"></div>
                                            <div class="item-childs-link pr-2  justify-content-between align-items-center"
                                                ...
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.7072 13.7072L8.4143 6.99994L1.70718 0.292969L0.292984 1.7072L5.58587 6.99997L0.292968 12.293L1.7072 13.7072Z" fill="white"/>
                                            </svg>

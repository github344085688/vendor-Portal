<template>
    <div style="  top: 0; left: 0; bottom: 0; right: 0; width: 100%; height: 100%">
        <div class="d-flex" style="height: 100%" v-if="moudleState=='operation'">
            ...
            <div class="col-8 media-pl-80 col-media pr-0">
                ...
                <div class=" d-flex media-t-4 flex-wrap" style="height: calc(100% - 150px);   position: absolute; left:20px; top: 120px; ">
                    <div class="po-r wid100">
                    <Transition name="topInLoging" mode="out-in">
                        <transition-group class="wid70 pr-0 po-a"  tag="div" v-if="moudleName =='welcomeToUnis'" >

                                <Form @submit="onSubmit" key="welcomeToUnis" class="d-flex flex-column" :validation-schema="schema"
                                    ...
                                    <div class="win100 mt-4 po-r mb-2">
                                        ...
                                        <Field name="firstName" type="text" class="unis-input br-b-1 bg-no" :class = "[errors.firstName?'':'br-grey900']"
                                    ...
                                    <div class="win100 mt-4 po-r mb-2">
                                        ...
                                        <Field name="lastName" type="text" class="unis-input br-b-1 bg-no" :class = "[errors.lastName?'':'br-grey900']"
                                    ...
                                    <div class="win100 mt-4 po-r mb-2">
                                        ...
                                        <Field name="email" type="text" class="unis-input br-b-1 bg-no" :class = "[errors.email?'':'br-grey900']" v-model='verifyEmail.email' placeholder="name@company.com"
                                    ...
                                    <div class="win100 po-r mb-4 mt-2">
                                        ...
                                        <Field name="password" :type="isshowPassword?'password':'text'"
                                               ...
                                               class="unis-input br-b-1 bg-no" :class = "[errors.lastName?'':'br-grey900']" :error="errors.password"/>
                                    ...
                                    <div class="win100 mt-4 po-r mb-2">
                                        ...
                                        <Field name="password_confirmation" type="text" class="unis-input br-b-1  bg-no" :class = "[errors.lastName?'':'br-grey900']"
                    ...
                    <Transition name="topInLoging" mode="out-in">
                        <transition-group class="wid70 pr-0 po-a"  tag="div" v-if="isSwitchTellUsAboutYourBusiness" style="height: 100%;">

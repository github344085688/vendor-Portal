import {AxiosInstance, AxiosRequestConfig, AxiosPromise, AxiosRequestHeaders} from 'axios';
...
class Rx4axios {
    ...
    private _makeRequest<T>(method: string, url: string, queryParams?: object, body?: object, headers?: AxiosRequestHeaders,) {
    ...
    public get<T>(url: string, queryParams?: object, headers?: AxiosRequestHeaders) {
        return this._makeRequest<T>('GET', url, queryParams, {}, headers);
    }

    public post<T>(url: string, body: object, queryParams?: object, headers?: AxiosRequestHeaders) {
        return this._makeRequest<T>('POST', url, queryParams, body, headers);
    }

    public put<T>(url: string, body: object, queryParams?: object, headers?: AxiosRequestHeaders) {
        return this._makeRequest<T>('PUT', url, queryParams, body, headers);
    }

    public patch<T>(url: string, body: object, queryParams?: object, headers?: AxiosRequestHeaders) {
        return this._makeRequest<T>('PATCH', url, queryParams, body, headers);
    }

    public delete<T>(url: string, queryParams?: object, headers?: AxiosRequestHeaders) {
